...
export function pulseOscillatorDefs(
  id: string,
...
@keyframes beam-hue-shift-${id} {
  ...
  const whiteGradient = isDark
    ? `conic-gradient(
        ...
        color-mix(in srgb, var(--beam-tint, #fff) 10%, transparent) 57%,
        color-mix(in srgb, var(--beam-tint, #fff) 30%, transparent) 60%,
        color-mix(in srgb, var(--beam-tint, #fff) 60%, transparent) 63%,
        color-mix(in srgb, var(--beam-tint, #fff) 75%, transparent) 66%,
        color-mix(in srgb, var(--beam-tint, #fff) 60%, transparent) 69%,
        color-mix(in srgb, var(--beam-tint, #fff) 30%, transparent) 72%,
        color-mix(in srgb, var(--beam-tint, #fff) 10%, transparent) 75%,
        transparent 78%, transparent 100%
      )`
    : `conic-gradient(
        from var(--beam-angle-${id}),
        transparent 0%, transparent 54%,
        color-mix(in srgb, var(--beam-tint, #000) 8%, transparent) 57%,
        color-mix(in srgb, var(--beam-tint, #000) 20%, transparent) 60%,
        color-mix(in srgb, var(--beam-tint, #000) 40%, transparent) 63%,
        color-mix(in srgb, var(--beam-tint, #000) 55.0%, transparent) 66%,
        color-mix(in srgb, var(--beam-tint, #000) 40%, transparent) 69%,
        color-mix(in srgb, var(--beam-tint, #000) 20%, transparent) 72%,
        color-mix(in srgb, var(--beam-tint, #000) 8%, transparent) 75%,
        transparent 78%, transparent 100%
      )`
  ...
  const bloomGradient = isDark
    ? `conic-gradient(
        ...
        color-mix(in srgb, var(--beam-tint, #fff) 3%, transparent) 62%,
        color-mix(in srgb, var(--beam-tint, #fff) 8%, transparent) 65%,
        color-mix(in srgb, var(--beam-tint, #fff) 20%, transparent) 67%,
        color-mix(in srgb, var(--beam-tint, #fff) 45%, transparent) 69%,
        color-mix(in srgb, var(--beam-tint, #fff) 85%, transparent) 70%,
        color-mix(in srgb, var(--beam-tint, #fff) 85%, transparent) 70.5%,
        color-mix(in srgb, var(--beam-tint, #fff) 45%, transparent) 71.5%,
        color-mix(in srgb, var(--beam-tint, #fff) 20%, transparent) 73%,
        color-mix(in srgb, var(--beam-tint, #fff) 8%, transparent) 75%,
        color-mix(in srgb, var(--beam-tint, #fff) 3%, transparent) 78%,
        transparent 82%
      )`
    : `conic-gradient(
        from var(--beam-angle-${id}),
        transparent 0%, transparent 58%,
        color-mix(in srgb, var(--beam-tint, #000) 2%, transparent) 62%,
        color-mix(in srgb, var(--beam-tint, #000) 8%, transparent) 65%,
        color-mix(in srgb, var(--beam-tint, #000) 20%, transparent) 67%,
        color-mix(in srgb, var(--beam-tint, #000) 40%, transparent) 69%,
        color-mix(in srgb, var(--beam-tint, #000) 60%, transparent) 70%,
        color-mix(in srgb, var(--beam-tint, #000) 60%, transparent) 70.5%,
        color-mix(in srgb, var(--beam-tint, #000) 40%, transparent) 71.5%,
        color-mix(in srgb, var(--beam-tint, #000) 20%, transparent) 73%,
        color-mix(in srgb, var(--beam-tint, #000) 8%, transparent) 75%,
        color-mix(in srgb, var(--beam-tint, #000) 2%, transparent) 78%,
        transparent 82%
      )`
